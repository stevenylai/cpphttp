...
namespace http {
  WebServerImpl::Setup(const WebServerSettings &settings)
  {
    m_Settings = settings;
    m_Dynamic = {
      ...
      /* .mountpoint_len */		m_Settings.StaticFilePath.length(),		/* char count */
                ...
                void *user, void *in, size_t len)
  {
	...
	case LWS_CALLBACK_HTTP:
      ...
      // Dispatch to handler according to the path
      // handler.Prepare();
      break;
